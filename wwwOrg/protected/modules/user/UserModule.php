...
class UserModule extends CWebModule
{
	...
	public $administrationUrl = array("/user/administration");
	public $managementUrl = array("/user/management");
	...
	public $tableUsers = '{{managers}}';
	public $tableEmployees = '{{employees}}';
	public $tableVisiteurs = '{{visiteurs}}';
	...
	static private $_employe;
	static private $_employes;
	...
	public static function isAdmin() {
		...
		if ($employees || $visiteurs) return false;
	...
	public static function getManagers() {
		if (!self::$_managers) {
			...
			self::$_managers = $return_name;
		}
		return self::$_managers;
	}
	
	/**
	 * Return employe status.
	 * @return boolean
	 */
	...
	public static function isEmploye() {
		if(Yii::app()->user->isGuest)
			...
			if (!isset(self::$_employe)) {
				if(self::user()->employe)
					self::$_employe = true;
				else
					self::$_employe = false;	
			}
	...
	public static function getEmployes() {
		if (!self::$_employes) {
			$employes = User::model()->active()->employe()->findAll();
			$return_name = array();
			foreach ($employes as $employe)
				array_push($return_name,$employe->username);
			self::$_employes = $return_name;
		}

...
/*	$creditEmpDis = HistoCreditsHcr::model()->find('uti_id=:uti_id',
	...
	*/
	...
	$creditEmpDis = Employees::model()->find('id=:id',array(':id'=>$id,));
	
	$creDis = $creditEmpDis->tempsInitialformation - $creditEmpDis->tempsActuelformation;

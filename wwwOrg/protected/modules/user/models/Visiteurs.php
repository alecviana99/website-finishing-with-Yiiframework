...
class Visiteurs extends CActiveRecord
{
	...
	{
		return Yii::app()->getModule('user')->tableVisiteurs;
	}
	...
	public function scopes()
    {
        return array(
            ...
            'notsafe'=>array(
            	'select' => 'id, username, password, email, name, first_name, phone, entreprise, address, activkey, createtime, lastvisit, status, idcreateur',
            ),
        );
    }
    ...
    {
        return array(
            'select' => 'id,  username, email, name, first_name, phone, entreprise, address, createtime, lastvisit, status, idcreateur');
    }

    ...
    <div class="container">
      ...
      <div class="nav-collapse collapse">
        <ul class="nav">
          ...
          <li class=" <?php if(($page == '')||($page == 'pricing-tables2')||($page == 'elements')) echo 'active';?> dropdown">
              <a href="#" data-description="cool features" class="dropdown-toggle" data-toggle="dropdown">Features <b class="caret"></b></a>
              <ul class="dropdown-menu">
                <li><a href="index.php?page=GRH">Livre de GRH</a></li>
                <li><a href="index.php?page=other">Autre livre</a></li>
              </ul><!--/.dropdown-menu -->
          </li><!--/.dropdown -->
